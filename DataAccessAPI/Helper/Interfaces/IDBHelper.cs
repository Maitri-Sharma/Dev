...
namespace DataAccessAPI.Helper.Interfaces.DBHelper
{
    /// <summary>
    ...
    public interface IDBHelper
    {
        ...
        int ExecuteNonQuery(string sql, CommandType commandType, params NpgsqlParameter[] parameters);
        ...
        T ExecuteScalar<T>(string sql, CommandType commandType, params NpgsqlParameter[] parameters);
        ...
        bool ExecuteReader(string sql, CommandType commandType, Func<IDataReader, bool> populate, params NpgsqlParameter[] parameters);
        ...
        DataSet FillDataSet(string sql, CommandType commandType, params NpgsqlParameter[] parameters);
        ...
        DataTable FillDataTable(string sql, CommandType commandType, params NpgsqlParameter[] parameters);
        ...
        T Execute<T>(string sql, CommandType commandType, Func<IDbCommand, T> function, params NpgsqlParameter[] parameters);
        ...
        NpgsqlParameter CreateOutputParameter(string name, NpgsqlDbType type, int size);
        ...
        NpgsqlParameter CreateOutputParameter(string name, NpgsqlDbType type);
        ...
        NpgsqlParameter CreateParameter(string name, NpgsqlDbType type, object value);
        ...
        NpgsqlParameter CreateParameter(string name, NpgsqlDbType type, int size, object value);
