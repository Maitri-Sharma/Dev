...
{
    public partial class UtvalgService : UtvalgBase
    {
        public UtvalgService()
        {
        }

        public UtvalgService(int id, int parentId, PumaEnum.UtvalgsTypeKode utvalgsType, string navn, int antall, DateTime sistOppdatert, string previewURL, string sistEndretAv)
        {
            base.UtvalgId = id;
